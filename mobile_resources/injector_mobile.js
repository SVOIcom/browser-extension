...
//console.log('HELLO INJECTOR MOBILE');
...
//Inject TONCLient
    injectScriptUrl("**injection**www/ton-client/main.js");

//Inject new TON lib
    injectScriptUrl("**injection**www/ever-sdk-js/main.js");

//Set Everscale binary url
    evalScript(`window.tonWasmUrl = "**injection**www/ton-client/tonclient.wasm";`);

//Set new Everscale binary url
    evalScript(`window.tonNewWasmUrl = "**injection**www/ever-sdk-js/eversdk.wasm";`);

//Thridrparty modules
    injectModuleUrl("**injection**www/modules/thirdparty/eventemitter3.min.js");

//Start Everscale provider
    injectModuleUrl("**injection**www/everscaleProvider.js");
